...
const FREQUENT_LEDGER_FUNDER_ALIASES = Object.freeze([
  ...
  'redshift capital',
  'redshift',
  // 2026-09-04 never-pre-matched qualified firms still missing from force-include.
  'index ventures',
  'creandum',
  'hv capital',
  'headline',
...
const ALIAS_FAMILY = Object.freeze({
  ...
  singular: 'singular',
  missionog: 'missionog',
  'harbert growth partners': 'harbert',
  harbert: 'harbert',
  'rally ventures': 'rally',
  rally: 'rally',
  'great north ventures': 'great_north',
  'great north': 'great_north',
  'grotech ventures': 'grotech',
  grotech: 'grotech',
  'crosslink capital': 'crosslink',
  crosslink: 'crosslink',
  'outsiders fund': 'outsiders',
  outsiders: 'outsiders',
  partech: 'partech',
  'partech impact': 'partech',
  'south park commons': 'south_park_commons',
  'tq ventures': 'tq',
  tq: 'tq',
  'lockheed martin ventures': 'lockheed_martin',
  ...
  creandum: 'creandum',
  'hv capital': 'hv_capital',
  headline: 'headline',
  signalfire: 'signalfire',
  'lowercarbon capital': 'lowercarbon',
  lowercarbon: 'lowercarbon',
  'salesforce ventures': 'salesforce_ventures',
  'theory ventures': 'theory',
  'desai ventures': 'desai',
  'ananda impact ventures': 'ananda',
  ananda: 'ananda',
  'fpv ventures': 'fpv',
  fpv: 'fpv',
  'robin capital': 'robin_capital',
  'liberty city ventures': 'liberty_city',
  'alumni ventures': 'alumni_ventures',
  'plural ventures': 'plural',
  plural: 'plural',
  frst: 'frst',
  'coinbase ventures': 'coinbase_ventures',
  ventech: 'ventech',
  stellaris: 'stellaris',
  'stellaris venture partners': 'stellaris',
  'adobe ventures': 'adobe_ventures',
  '3one4 capital': '3one4',
  '3one4': '3one4',
  '20vc': '20vc',
  'sv angel': 'sv_angel',
