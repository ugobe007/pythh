...
const FAQ = [
  ...
  },
  {
    ...
    a: "The GOD score (0–100) evaluates startups across five dimensions: Team, Traction, Market, Product, and Vision. Vision measures destination scale — investors look for large visions, not small ones, especially from repeat founders who have done it before. Determination is the rare persistence trait most investors miss; we screen it with 12 proxy signals, not confidence or charisma. The score determines match quality and investor fit.",
  },
  {
    q: "Is pythh.ai free?",
