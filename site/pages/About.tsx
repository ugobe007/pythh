...
const WHAT_WE_DO = [
  ...
  {
    title: "GOD Score",
    desc: "Every startup is evaluated across five dimensions: Team, Traction, Market, Product, and Vision. Vision rewards large, category-scale ambition — not a small product story — especially from founders who have done it before. Determination — the rare founder trait most investors miss — is screened through 12 proxy signals, not charisma. The composite score (0–100) determines match quality and investor fit.",
  },
  {
