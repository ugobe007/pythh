-- get_sector_heat: replace self-join with lateral unnest (avoids row explosion / timeouts on large tables)
-- GRANT: ensure anon/authenticated can invoke RPCs used by the browser client
