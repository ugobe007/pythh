-- Expose maturity (degree) fields from get_startup_context for the product UI
...
COMMENT ON FUNCTION public.get_startup_context IS
  'Returns data for startup profile. Includes maturity_level / maturity_score / maturity_gaps for UI.';
