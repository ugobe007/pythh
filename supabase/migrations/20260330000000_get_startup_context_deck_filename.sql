-- Add deck_filename to get_startup_context RPC for ImproveScoreWizard
-- Founders who already uploaded a deck should see "Deck uploaded" in step 2
...
COMMENT ON FUNCTION public.get_startup_context IS 
  'Returns data for /app/startup page. Includes deck_filename/deck_url for ImproveScoreWizard.';
