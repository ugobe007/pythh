...
const SEED = [
  ...
  { name: "Michael Chen",       role: "General Partner",    firm: "Andreessen Horowitz",    sector: "AI/ML",    sector2: "Robotics", signal: 77, delta: -1,  god: 71, vcpp: 81, checkSize: "$10–50M", stage: "Series A/B",  geo: "US",     recentActivity: "Portfolio expansion",   isPublic: 1 },
  ...
  { name: "Zavain Dar",         role: "Partner",            firm: "Lux Capital",            sector: "DeepTech", sector2: "Robotics", signal: 71, delta:  0,  god: 65, vcpp: 75, checkSize: "$5–20M",  stage: "Series A",    geo: "US",     recentActivity: "New fund deploy",       isPublic: 0 },
  { name: "Josh Wolfe",         role: "Co-founder & Managing Partner", firm: "Lux Capital", sector: "DeepTech", sector2: "Robotics", signal: 75, delta:  3,  god: 69, vcpp: 79, checkSize: "$5–25M",  stage: "Series A/B",  geo: "US",     recentActivity: "Portfolio expansion",   isPublic: 0 },

  // ── Robotics ──────────────────────────────────────────────────────────────
  { name: "Playground Global",  role: "Partner",            firm: "Playground Global",      sector: "Robotics", sector2: "DeepTech", signal: 82, delta:  3,  god: 76, vcpp: 86, checkSize: "$2–15M",  stage: "Seed/A",      geo: "US",     recentActivity: "Hardware thesis",       isPublic: 1 },
  { name: "Peter Barrett",      role: "General Partner",    firm: "Playground Global",      sector: "Robotics", sector2: "AI/ML",    signal: 78, delta:  1,  god: 72, vcpp: 82, checkSize: "$2–10M",  stage: "Seed/A",      geo: "US",     recentActivity: "Active sourcing",       isPublic: 0 },
  { name: "DCVC",               role: "Partner",            firm: "DCVC",                   sector: "Robotics", sector2: "DeepTech", signal: 77, delta:  0,  god: 71, vcpp: 81, checkSize: "$3–20M",  stage: "Series A",    geo: "US",     recentActivity: "Deep tech fund",        isPublic: 1 },
  { name: "Eclipse Ventures",   role: "Partner",            firm: "Eclipse",                sector: "Robotics", sector2: "Enterprise", signal: 76, delta: 2, god: 70, vcpp: 80, checkSize: "$5–25M",  stage: "Series A/B",  geo: "US",     recentActivity: "Industrial automation", isPublic: 1 },
  { name: "Khosla Ventures",    role: "Partner",            firm: "Khosla Ventures",        sector: "Robotics", sector2: "Climate",  signal: 74, delta:  1,  god: 68, vcpp: 78, checkSize: "$5–30M",  stage: "Series A/B",  geo: "US",     recentActivity: "Hard tech bets",        isPublic: 1 },
  { name: "Founders Fund",      role: "Partner",            firm: "Founders Fund",          sector: "Robotics", sector2: "SpaceTech", signal: 78, delta: 1, god: 72, vcpp: 82, checkSize: "$5–50M",  stage: "Series A/B",  geo: "US",     recentActivity: "Frontier systems",      isPublic: 1 },
  { name: "Toyota Ventures",    role: "Managing Director",  firm: "Toyota Ventures",        sector: "Robotics", sector2: "DeepTech", signal: 73, delta:  2,  god: 67, vcpp: 77, checkSize: "$2–15M",  stage: "Seed/A",      geo: "US",     recentActivity: "Mobility robotics",     isPublic: 1 },
  { name: "Root Ventures",      role: "General Partner",    firm: "Root Ventures",          sector: "Robotics", sector2: "DeepTech", signal: 72, delta:  0,  god: 66, vcpp: 76, checkSize: "$500K–5M", stage: "Seed",       geo: "US",     recentActivity: "Manufacturing stack",   isPublic: 0 },
  { name: "SOSV",               role: "Partner",            firm: "SOSV (HAX)",             sector: "Robotics", sector2: null,       signal: 71, delta:  3,  god: 65, vcpp: 75, checkSize: "$250K–2M", stage: "Pre-seed",   geo: "Global", recentActivity: "Hardware incubator",    isPublic: 1 },
  { name: "Autotech Ventures",  role: "Partner",            firm: "Autotech Ventures",      sector: "Robotics", sector2: "DeepTech", signal: 70, delta:  1,  god: 64, vcpp: 74, checkSize: "$1–8M",   stage: "Seed/A",      geo: "US",     recentActivity: "Autonomy focus",        isPublic: 0 },
  { name: "Innovation Endeavors", role: "Partner",          firm: "Innovation Endeavors",   sector: "Robotics", sector2: "AI/ML",    signal: 69, delta:  2,  god: 63, vcpp: 73, checkSize: "$2–10M",  stage: "Seed/A",      geo: "US",     recentActivity: "Engineering bets",      isPublic: 0 },
  { name: "8VC",                role: "Partner",            firm: "8VC",                    sector: "Robotics", sector2: "Enterprise", signal: 68, delta: 0, god: 62, vcpp: 72, checkSize: "$2–15M",  stage: "Seed/A",      geo: "US",     recentActivity: "Logistics automation",  isPublic: 0 },
  { name: "Engine Ventures",    role: "Managing Partner",   firm: "Engine Ventures",        sector: "Robotics", sector2: "DeepTech", signal: 67, delta:  1,  god: 61, vcpp: 71, checkSize: "$1–5M",   stage: "Seed",        geo: "US",     recentActivity: "Tough tech",            isPublic: 0 },
  { name: "B Capital Group",      role: "Partner",            firm: "B Capital Group",        sector: "Robotics", sector2: "AI/ML",    signal: 66, delta:  2,  god: 60, vcpp: 70, checkSize: "$5–25M",  stage: "Series A/B",  geo: "US",     recentActivity: "Autonomy exposure",     isPublic: 1 },
  { name: "Prime Movers Lab",     role: "Partner",            firm: "Prime Movers Lab",       sector: "Robotics", sector2: "SpaceTech", signal: 68, delta: 1, god: 62, vcpp: 72, checkSize: "$3–15M",  stage: "Series A",    geo: "US",     recentActivity: "Hard science deploy",   isPublic: 0 },
  ...
  // ── SpaceTech ─────────────────────────────────────────────────────────────
  { name: "Steve Jurvetson",    role: "Co-founder & Partner", firm: "Future Ventures",      sector: "SpaceTech", sector2: "Robotics", signal: 73, delta: 2, god: 67, vcpp: 77, checkSize: "$5–25M",  stage: "Series A/B",  geo: "US",     recentActivity: "Thesis match",          isPublic: 1 },
