...
import { Orbit, Satellite, Rocket, Users } from 'lucide-react';
...
const SpaceTechInvestorsPage: React.FC = () => {
  ...
  const loadSectorData = async () => {
    try {
      ...
      console.error('Error loading SpaceTech sector data:', error);
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-black to-slate-950">
      <SEO
        title="Top SpaceTech Investors – Orbital, Satellite, Launch, Defense Space | Pythh"
        description="Find investors actively funding SpaceTech startups: launch systems, satellites, orbital infrastructure, and dual-use space platforms."
        keywords="spacetech investors, space startup investors, satellite VC, orbital infrastructure funding, launch tech investors"
        canonical="/spacetech-investors"
      />
      <PythhUnifiedNav />
      ...
      <div className="container mx-auto px-4 pt-24 pb-16">
        <div className="text-center mb-16">
          ...
          <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-white via-indigo-200 to-cyan-300 bg-clip-text text-transparent">
            Top SpaceTech Investors
          </h1>

          <p className="text-xl text-slate-300 max-w-3xl mx-auto mb-12">
            Investors backing launch, satellite platforms, in-space infrastructure, and frontier aerospace systems.
          </p>
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-white mb-8">Leading SpaceTech Investors</h2>
          {loading ? (
            <div className="text-center py-12">
              <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-indigo-300 mx-auto" />
            </div>
          ) : (
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-white mb-8">High-scoring SpaceTech Startups</h2>
...
export default SpaceTechInvestorsPage;
