    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      ...
      <div className="container mx-auto px-4 pt-24 pb-16">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-md bg-rose-500/10 text-rose-200/95 mb-6">
            <Heart className="w-4 h-4 text-rose-400" />
            <span className="font-medium">HealthTech Sector</span>
          </div>
                ...
                <div key={investor.id} className="bg-white/[0.03] rounded-lg p-5 backdrop-blur-sm transition-colors hover:bg-white/[0.06]">
                  <div className="flex items-start justify-between mb-4">
                    ...
                    {investor.total_score && (
                      <div className="px-2 py-0.5 rounded-md bg-rose-500/15">
                        <span className="text-rose-200 font-bold tabular-nums">{investor.total_score}</span>
                      </div>
                    )}
                  </div>
            ...
            {startups.map((startup) => (
              <div key={startup.id} className="bg-white/[0.03] rounded-lg p-5 backdrop-blur-sm transition-colors hover:bg-white/[0.06]">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="px-2 py-0.5 rounded-md bg-rose-500/15">
                    <span className="text-rose-200 text-sm font-bold tabular-nums">{startup.total_god_score}</span>
                  </div>
                </div>
