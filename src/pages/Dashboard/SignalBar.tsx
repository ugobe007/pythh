...
interface SignalBarProps {
  snapshot: Pick<
    SignalSnapshot,
    'stage' | 'momentum' | 'signalStrength' | 'category' | 'timingWindow' | 'mode'
  >;
}

export default function SignalBar({ snapshot }: SignalBarProps) {
  const { stage, momentum, signalStrength, category, timingWindow: timing, mode } = snapshot;
  const momentumColor = {
