-- ============================================================================
-- FINAL FIX: Use INTEGER comparisons for stage
-- ============================================================================
-- Problem: stage column is INTEGER, but function was comparing to TEXT
-- Solution: Use integer codes (1=Pre-Seed, 2=Seed, 3=Series A, etc.)
-- ============================================================================
...
-- Test it
SELECT * FROM get_hot_matches(3, 168);
