...
const profiles = [
  ...
  {
    canonicalName: '3one4 Capital', firm: '3one4 Capital', url: 'https://www.3one4.com/',
    sectors: ['SaaS', 'Fintech', 'AI/ML', 'Consumer'],
    stage: ['Seed', 'Series A'], geography: ['India', 'Global'],
    thesis: 'India-focused early-stage venture firm.',
    source: 'https://www.3one4.com/', type: 'VC', investorType: 'VC',
  },
  {
    canonicalName: '450 Ventures', firm: '450 Ventures', url: null,
    sectors: ['Technology', 'SaaS'],
    stage: ['Seed', 'Series A'], geography: ['Global'],
    thesis: 'Early-stage venture firm appearing in post-prediction funding ledgers.',
    source: null, type: 'VC', investorType: 'VC',
  ...
  {
    canonicalName: '216 Capital', firm: '216 Capital', url: 'https://www.216capital.com/',
    sectors: ['Technology', 'SaaS', 'AI/ML'],
    stage: ['Seed', 'Series A'], geography: ['Europe', 'Global'],
    thesis: 'European early-stage venture firm.',
    source: 'https://www.216capital.com/', type: 'VC', investorType: 'VC',
  },
  {
    canonicalName: '4impact Capital', firm: '4impact Capital', url: null,
    sectors: ['Impact', 'Climate Tech', 'Technology'],
    stage: ['Seed', 'Series A'], geography: ['Global'],
    thesis: 'Impact-oriented early-stage investor.',
    source: null, type: 'VC', investorType: 'VC',
  },
  {
    canonicalName: 'Pentathlon Ventures', firm: 'Pentathlon Ventures', url: null,
    sectors: ['Technology', 'SaaS', 'Consumer'],
    stage: ['Seed', 'Series A'], geography: ['India', 'Global'],
    thesis: 'Early-stage venture firm appearing in post-prediction funding ledgers.',
    source: null, type: 'VC', investorType: 'VC',
  },
  {
    canonicalName: 'Ethereal Ventures', firm: 'Ethereal Ventures', url: null,
    sectors: ['Crypto', 'AI/ML', 'Infrastructure'],
    stage: ['Seed', 'Series A'], geography: ['Global'],
    thesis: 'Early-stage crypto and technology investor.',
    source: null, type: 'VC', investorType: 'VC',
  },
  {
    canonicalName: 'Zoho', firm: 'Zoho', url: 'https://www.zoho.com/',
    sectors: ['SaaS', 'Enterprise', 'AI/ML'],
    stage: ['Seed', 'Series A', 'Growth'], geography: ['Global'],
    thesis: 'Corporate strategic investor in software ecosystems.',
    source: 'https://www.zoho.com/', type: 'Corporate', investorType: 'Corporate',
  },
  {
    canonicalName: 'CIBC Innovation Banking', firm: 'CIBC Innovation Banking', url: 'https://www.cibc.com/',
    sectors: ['Fintech', 'Technology', 'SaaS'],
    stage: ['Series A', 'Series B', 'Growth'], geography: ['Canada', 'United States', 'Global'],
    thesis: 'Bank-affiliated growth capital for innovation companies.',
    source: 'https://www.cibc.com/', type: 'Corporate', investorType: 'Growth',
  },
  {
    canonicalName: 'KPS Capital', firm: 'KPS Capital', url: null,
    sectors: ['Technology', 'Industrial'],
    stage: ['Growth', 'Buyout'], geography: ['Global'],
    thesis: 'Private equity / growth investor appearing in funding ledgers.',
    source: null, type: 'PE', investorType: 'PE',
  },
  {
    canonicalName: 'Bpifrance Amorçage Industriel', firm: 'Bpifrance', displayName: 'Bpifrance Amorçage Industriel', url: 'https://www.bpifrance.fr/',
    sectors: ['Industrial', 'DeepTech', 'Climate Tech'],
    stage: ['Seed', 'Series A'], geography: ['France', 'Europe'],
    thesis: 'French public investment bank industrial seed vehicle.',
    source: 'https://www.bpifrance.fr/', type: 'Corporate', investorType: 'Corporate',
  },
  {
    canonicalName: 'MPCi', firm: 'MPCi', url: null,
    sectors: ['Technology', 'AI/ML'],
    stage: ['Seed', 'Series A'], geography: ['Global'],
    thesis: 'Early-stage investor appearing in post-prediction funding ledgers.',
    source: null, type: 'VC', investorType: 'VC',
  ...
  {
    canonicalName: 'Unbound', firm: 'Unbound', url: null,
    sectors: ['Technology', 'SaaS'],
    stage: ['Seed', 'Series A'], geography: ['Global'],
    thesis: 'Early-stage investor appearing in post-prediction funding ledgers.',
    source: null, type: 'VC', investorType: 'VC',
  ...
  {
    canonicalName: 'Varrock', firm: 'Varrock', url: null,
  ...
  {
    canonicalName: 'Coalesce', firm: 'Coalesce', url: null,
    sectors: ['Technology', 'SaaS'],
    stage: ['Seed', 'Series A'], geography: ['Global'],
    thesis: 'Early-stage investor appearing in post-prediction funding ledgers.',
    source: null, type: 'VC', investorType: 'VC',
  ...
  {
    canonicalName: 'Tayeh Capital', firm: 'Tayeh Capital', url: null,
    sectors: ['Technology', 'Fintech'],
    stage: ['Seed', 'Series A'], geography: ['Global'],
    thesis: 'Early-stage venture firm appearing in post-prediction funding ledgers.',
    source: null, type: 'VC', investorType: 'VC',
  ...
  {
    canonicalName: 'GordonMD Global Investments', firm: 'GordonMD Global Investments', url: null,
  ...
  // Proception $11M seed (TechCrunch 2026-06-29). Firm rows already exist; attach orgs + first-party URLs.
  {
    canonicalName: 'First Round Capital', firm: 'First Round Capital', url: 'https://www.firstround.com/',
    sectors: ['Technology', 'SaaS', 'AI/ML', 'Consumer'],
    stage: ['Pre-Seed', 'Seed'], geography: ['United States'],
    thesis: 'Early-stage firm that led Proception’s $11M seed for dexterous robot hands.',
    source: 'https://www.firstround.com/', type: 'VC', investorType: 'VC',
  },
  {
    canonicalName: 'BoxGroup', firm: 'BoxGroup', url: 'https://www.boxgroup.com/',
    sectors: ['Technology', 'SaaS', 'AI/ML'],
    stage: ['Pre-Seed', 'Seed'], geography: ['United States'],
    thesis: 'NYC early-stage fund; participated in Proception’s $11M seed with First Round and YC.',
    source: 'https://www.boxgroup.com/', type: 'VC', investorType: 'VC',
  },
  // Corgi Series B1 (PR Newswire 2026-05-28). Skip Prime Capital (do not equate to F-Prime) and people.
  {
    canonicalName: 'TCV', firm: 'TCV', url: 'https://www.tcv.com/',
    sectors: ['Technology', 'Fintech', 'SaaS', 'InsurTech'],
    stage: ['Series B', 'Growth'], geography: ['United States', 'Global'],
    thesis: 'Growth-stage technology investor; led Corgi’s $106M Series B1 at a $2.6B valuation.',
    source: 'https://www.tcv.com/', type: 'VC', investorType: 'Growth',
  },
  {
    canonicalName: 'Zone 2 Ventures', firm: 'Zone 2 Ventures', url: 'https://www.zone2.vc/',
    sectors: ['InsurTech', 'Fintech', 'AI/ML'],
    stage: ['Seed', 'Series A', 'Series B'], geography: ['Europe', 'Global'],
    thesis: 'Early-stage firm (also Zone II Ventures) that participated in Corgi’s Series B1.',
    source: 'https://www.zone2.vc/', type: 'VC', investorType: 'VC',
  },
  {
    canonicalName: 'Leblon Capital', firm: 'Leblon Capital', url: 'https://leblon-capital.notion.site',
    sectors: ['Technology', 'Fintech'],
    stage: ['Seed', 'Series A', 'Series B'], geography: ['Global'],
    thesis: 'Participated in Corgi’s $106M Series B1.',
  ...
  },
  {
    ...
    source: 'https://www.kindredvc.com/', type: 'VC', investorType: 'VC',
  },
  {
    canonicalName: 'Quadri Ventures', firm: 'Quadri Ventures', url: 'https://quadri.vc/',
    sectors: ['AI/ML', 'Enterprise', 'Infrastructure'],
    stage: ['Seed', 'Series A', 'Series B'], geography: ['United States', 'Europe'],
    checkMin: 1500000, checkMax: 5000000,
    thesis: 'NY/London firm backing enterprise AI, physical AI, and infrastructure; Corgi Series B1 participant.',
    source: 'https://quadri.vc/', type: 'VC', investorType: 'VC',
  },
  {
    canonicalName: 'First Order Fund', firm: 'First Order Fund', url: 'https://www.firstorderfund.com/',
    sectors: ['Technology', 'AI/ML'],
    stage: ['Seed', 'Series A', 'Series B'], geography: ['United States'],
    thesis: 'Participated in Corgi’s $106M Series B1.',
    source: 'https://www.firstorderfund.com/', type: 'VC', investorType: 'VC',
  },
  {
    canonicalName: 'Vocal Ventures', firm: 'Vocal Ventures', url: 'https://www.vocalventures.co/',
    sectors: ['AI/ML', 'SaaS', 'InsurTech'],
    stage: ['Pre-Seed', 'Seed', 'Series A'], geography: ['United States'],
    thesis: 'Bay Area AI seed firm; Corgi is in the public portfolio and joined the Series B1.',
    source: 'https://www.vocalventures.co/', type: 'VC', investorType: 'VC',
  },
  {
    canonicalName: 'Nordstar', firm: 'Nordstar', url: 'https://www.nordstar.com/',
    sectors: ['Fintech', 'AI/ML', 'SaaS', 'Consumer'],
    stage: ['Series A', 'Series B', 'Growth'], geography: ['United Kingdom', 'Global'],
    thesis: 'London/NY growth investor in software and tech-enabled businesses; Corgi Series B1 participant.',
    source: 'https://www.nordstar.com/', type: 'VC', investorType: 'Growth',
  },
  {
    canonicalName: 'GSBackers', firm: 'GSBackers', url: 'https://gsbackers.com/',
    sectors: ['Technology'],
    stage: ['Seed', 'Series A', 'Series B'], geography: ['United States'],
    thesis: 'Stanford GSB alumni backer syndicate; named on Corgi’s Series B1 wire.',
    source: 'https://gsbackers.com/', type: 'VC', investorType: 'VC',
  },
  {
    canonicalName: 'Repeat Ventures', firm: 'Repeat Ventures', url: 'https://www.repeat.vc/',
    sectors: ['Technology', 'SaaS'],
    stage: ['Seed', 'Series A', 'Series B'], geography: ['Global'],
    thesis: 'Multi-city venture firm named on Corgi’s Series B1 wire.',
    source: 'https://www.repeat.vc/', type: 'VC', investorType: 'VC',
  },
  // Avatar Robotics $6.5M seed (PR Newswire 2026-08-05). Skip individual angels.
  {
    canonicalName: 'AlleyCorp', firm: 'AlleyCorp', url: 'https://alleycorp.com/',
    sectors: ['Technology', 'AI/ML', 'Robotics'],
    stage: ['Pre-Seed', 'Seed', 'Series A'], geography: ['United States'],
    thesis: 'NYC incubator/early-stage firm; led Avatar Robotics’ $6.5M seed.',
  ...
  },
  {
    ...
    source: 'https://defy.vc/', type: 'VC', investorType: 'VC',
  },
  {
    canonicalName: 'Headline', firm: 'Headline', url: 'https://headline.com/',
    sectors: ['Technology', 'SaaS', 'AI/ML'],
    stage: ['Seed', 'Series A', 'Series B'], geography: ['Global'],
    thesis: 'Global venture firm; participated in Avatar Robotics’ $6.5M seed.',
    source: 'https://headline.com/', type: 'VC', investorType: 'VC',
  },
  {
    canonicalName: 'REFASHIOND Ventures', firm: 'REFASHIOND Ventures', url: 'https://www.refashiond.com/',
    sectors: ['Supply Chain', 'Robotics', 'AI/ML'],
    stage: ['Pre-Seed', 'Seed', 'Series A'], geography: ['United States'],
  ...
  // Early-stage vehicles announced / closed in August 2026 (Free Search table).
  // Accel US / Europe / India map to the existing Accel firm — do not split regional funds.
  // Inovo already seeded.
  {
    canonicalName: 'Blackbird Ventures', firm: 'Blackbird Ventures', url: 'https://blackbird.vc/',
    sectors: ['AI/ML', 'SaaS', 'DeepTech', 'Climate Tech'],
    stage: ['Pre-Seed', 'Seed', 'Series A'], geography: ['Australia', 'New Zealand'],
    checkMin: 1000000, checkMax: 15000000,
    thesis: 'Australia/NZ early-stage firm; August 2026 Fund VI close backing pre-seed through Series A.',
    source: 'https://blackbird.vc/', type: 'VC', investorType: 'VC',
  },
  {
    canonicalName: 'South Park Commons', firm: 'South Park Commons', url: 'https://www.southparkcommons.com/',
    sectors: ['AI/ML', 'SaaS', 'Developer Tools', 'Fintech'],
    stage: ['Pre-Seed', 'Seed', 'Series A'], geography: ['United States'],
    checkMin: 1000000, checkMax: 10000000,
    thesis: 'Founder community that now leads seed and Series A from its August 2026 Fund IV.',
    source: 'https://www.southparkcommons.com/', type: 'VC', investorType: 'VC',
  },
  {
    canonicalName: 'OpenAI Startup Fund', firm: 'OpenAI Startup Fund', url: 'https://openai.com/index/openai-startup-fund/',
    sectors: ['AI/ML', 'Developer Tools', 'Enterprise'],
    stage: ['Seed', 'Series A'], geography: ['United States', 'Global'],
    checkMin: 1000000, checkMax: 25000000,
    thesis: 'OpenAI’s dedicated startup vehicle; August 2026 Fund II backing seed and Series A AI companies.',
    source: 'https://openai.com/index/openai-startup-fund/', type: 'VC', investorType: 'VC',
  },
  {
    canonicalName: 'Jump Capital', firm: 'Jump Capital', url: 'https://www.jumpcap.com/',
    sectors: ['AI/ML', 'Cybersecurity', 'Developer Tools', 'Infrastructure'],
    stage: ['Seed', 'Series A', 'Series B'], geography: ['United States'],
    checkMin: 1000000, checkMax: 10000000,
    thesis: 'Chicago early-stage firm; August 2026 Fund 8 focused on AI infrastructure, security, and tooling.',
    source: 'https://www.jumpcap.com/', type: 'VC', investorType: 'VC',
  },
  {
    canonicalName: 'Team8', firm: 'Team8', url: 'https://team8.vc/',
    sectors: ['Cybersecurity', 'AI/ML', 'Enterprise', 'Fintech'],
    stage: ['Seed', 'Series A'], geography: ['Israel', 'United States'],
    checkMin: 5000000, checkMax: 15000000,
    thesis: 'Tel Aviv venture builder; August 2026 fund backing AI-native enterprise security.',
    source: 'https://team8.vc/', type: 'VC', investorType: 'VC',
  },
  {
    canonicalName: 'Reach Capital', firm: 'Reach Capital', url: 'https://reachcapital.com/',
    sectors: ['EdTech', 'HealthTech', 'AI/ML', 'Future of Work'],
    stage: ['Pre-Seed', 'Seed', 'Series A'], geography: ['United States'],
    checkMin: 1000000, checkMax: 10000000,
    thesis: 'Early-stage firm backing AI for teachers, nurses, and hourly workers; August 2026 Fund V.',
    source: 'https://reachcapital.com/', type: 'VC', investorType: 'VC',
  },
  {
    canonicalName: 'Makers Fund', firm: 'Makers Fund', url: 'https://www.makersfund.com/',
    sectors: ['Gaming', 'Consumer', 'AI/ML'],
    stage: ['Seed', 'Series A'], geography: ['Global'],
    checkMin: 500000, checkMax: 40000000,
    thesis: 'Gaming-focused global firm; August 2026 Fund IV for seed and Series A interactive companies.',
    source: 'https://www.makersfund.com/', type: 'VC', investorType: 'VC',
  },
  {
    canonicalName: 'White Star Capital', firm: 'White Star Capital', url: 'https://whitestarcapital.com/',
    sectors: ['SaaS', 'Fintech', 'AI/ML', 'Consumer'],
    stage: ['Series A', 'Series B'], geography: ['United States', 'Europe', 'MENA', 'Asia'],
    checkMin: 5000000, checkMax: 15000000,
    thesis: 'Cross-border early-growth firm; August 2026 Fund IV leading Series A and B.',
    source: 'https://whitestarcapital.com/', type: 'VC', investorType: 'VC',
  },
  {
    canonicalName: 'Permanent Capital Ventures', firm: 'Permanent Capital Ventures', displayName: 'Permanent Capital', url: 'https://www.permanent-capital.vc/',
    sectors: ['AI/ML', 'Enterprise', 'SaaS'],
    stage: ['Series A'], geography: ['United States'],
    checkMin: 10000000, checkMax: 20000000,
    thesis: 'Operator-led Series A firm helping applied-AI founders build enterprise go-to-market; Fund II (2026).',
    source: 'https://www.permanent-capital.vc/', type: 'VC', investorType: 'VC',
  },
  {
    canonicalName: 'MassMutual Ventures', firm: 'MassMutual Ventures', url: 'https://www.massmutualventures.com/',
    sectors: ['Climate Tech', 'Fintech', 'Enterprise', 'HealthTech'],
    stage: ['Series A', 'Series B'], geography: ['North America'],
    checkMin: 2000000, checkMax: 5000000,
    thesis: 'MassMutual’s venture arm; August 2026 climate-tech Fund II plus broader Series A/B investing.',
    source: 'https://www.massmutualventures.com/', type: 'Corporate', investorType: 'Corporate',
  },
  {
    canonicalName: 'Floating Point', firm: 'Floating Point', url: 'https://floating.vc/',
    sectors: ['Healthcare', 'Fintech', 'Logistics', 'Energy', 'Defense'],
    stage: ['Seed', 'Series A'], geography: ['United States'],
    checkMin: 1000000, checkMax: 5000000,
    thesis: 'Boston/New York early-stage firm; August 2026 Fund III backing technology in complex legacy industries.',
    source: 'https://floating.vc/', type: 'VC', investorType: 'VC',
  },
  {
    canonicalName: '224 Ventures', firm: '224 Ventures', url: 'https://www.224ventures.com/',
    sectors: ['AI/ML', 'Robotics', 'Developer Tools', 'Infrastructure'],
    stage: ['Seed', 'Series A'], geography: ['United States'],
    checkMin: 1000000, checkMax: 5000000,
    thesis: 'Technical AI-native seed firm launched August 2026 with operator LPs across applications, robotics, and infrastructure.',
    source: 'https://www.224ventures.com/', type: 'VC', investorType: 'VC',
  },
  {
    canonicalName: 'Silent Ventures', firm: 'Silent Ventures', url: 'https://silentvc.com/',
    sectors: ['Defense', 'DeepTech', 'Aerospace', 'AI/ML'],
    stage: ['Pre-Seed', 'Seed'], geography: ['United States'],
    checkMin: 1000000, checkMax: 3000000,
    thesis: 'Early-stage defense and deep-tech investor; August 2026 Fund II.',
    source: 'https://silentvc.com/', type: 'VC', investorType: 'VC',
  },
  {
    canonicalName: 'Ventures Platform', firm: 'Ventures Platform', displayName: 'Ventures Platform', url: 'https://www.venturesplatform.com/',
    sectors: ['Fintech', 'SaaS', 'AI/ML', 'Climate Tech'],
    stage: ['Pre-Seed', 'Seed', 'Series A'], geography: ['Africa'],
    checkMin: 50000, checkMax: 3000000,
    thesis: 'Lagos pan-African firm; August 2026 Fund II backing pre-seed through Series A across the continent.',
    source: 'https://www.venturesplatform.com/', type: 'VC', investorType: 'VC',
  },
  {
    canonicalName: 'Cross-Border Impact Ventures', firm: 'Cross-Border Impact Ventures', url: 'https://www.crossborder.ventures/',
    sectors: ['HealthTech', 'Women’s Health', 'Climate Tech'],
    stage: ['Series A', 'Series B'], geography: ['Global', 'Emerging Markets'],
    checkMin: 2000000, checkMax: 5000000,
    thesis: 'Impact investor backing Series A/B health technology for women and children in emerging markets; 2026 Fund II.',
    source: 'https://www.crossborder.ventures/', type: 'VC', investorType: 'Impact',
  },
  {
    canonicalName: 'Psalion', firm: 'Psalion', url: 'https://psalion.com/',
    sectors: ['Crypto', 'Fintech', 'Infrastructure'],
    stage: ['Pre-Seed', 'Seed'], geography: ['Singapore', 'Global'],
    checkMin: 500000, checkMax: 2000000,
    thesis: 'Singapore digital-asset firm; August 2026 Fund III for blockchain infrastructure, RWA, and stablecoins.',
    source: 'https://psalion.com/', type: 'VC', investorType: 'VC',
  },
  {
    canonicalName: 'RunwayVC', firm: 'RunwayVC', url: 'https://www.runway.vc/',
    sectors: ['Robotics', 'Industrial', 'DeepTech', 'Climate Tech'],
    stage: ['Pre-Seed', 'Seed', 'Series A'], geography: ['Norway', 'Nordics', 'Europe'],
    checkMin: 450000, checkMax: 900000,
    thesis: 'Norwegian industrial-tech investor; August 2026 Fund II for Nordic robotics and automation.',
    source: 'https://www.runway.vc/', type: 'VC', investorType: 'VC',
  },
  {
    canonicalName: 'Bluehill VC', firm: 'Bluehill VC', url: 'https://www.bluehill.vc/',
    sectors: ['SaaS', 'Fintech', 'AI/ML'],
    stage: ['Seed', 'Series A'], geography: ['India'],
    checkMin: 1000000, checkMax: 2000000,
    thesis: 'India early-stage firm; August 2026 Fund I backing seed and Series A software companies.',
    source: 'https://www.bluehill.vc/', type: 'VC', investorType: 'VC',
  },
  {
    canonicalName: 'FGV Capital', firm: 'FGV Capital', url: 'https://fgv.vc/',
    sectors: ['Fintech', 'Payments', 'SaaS'],
    stage: ['Pre-Seed', 'Seed', 'Series A'], geography: ['United States'],
    checkMin: 1000000, checkMax: 1500000,
    thesis: 'Fintech specialist (rebranded Fiat Ventures); August 2026 Fund II.',
    source: 'https://fgv.vc/', type: 'VC', investorType: 'VC',
  },
  {
    canonicalName: 'GD1', firm: 'GD1', url: 'https://gd1.vc/',
    sectors: ['SaaS', 'DeepTech', 'Climate Tech', 'AI/ML'],
    stage: ['Pre-Seed', 'Seed'], geography: ['New Zealand'],
    checkMin: 500000, checkMax: 2000000,
    thesis: 'Auckland early-stage firm; August 2026 Core Fund II first close for New Zealand founders.',
    source: 'https://gd1.vc/', type: 'VC', investorType: 'VC',
  },
  {
    canonicalName: 'SaaS Holic', firm: 'SaaS Holic', url: 'https://www.saasholic.com/',
    sectors: ['SaaS', 'B2B', 'AI/ML'],
    stage: ['Pre-Seed', 'Seed'], geography: ['Latin America', 'United States'],
    checkMin: 1000000, checkMax: 1500000,
    thesis: 'LatAm/US SaaS specialist; August 2026 Fund III for pre-seed and seed software.',
    source: 'https://www.saasholic.com/', type: 'VC', investorType: 'VC',
  },
  {
    canonicalName: 'Redstone', firm: 'Redstone', url: 'https://www.redstone.vc/',
    sectors: ['DeepTech', 'Climate Tech', 'Industrial', 'Ocean Tech'],
    stage: ['Pre-Seed', 'Seed', 'Series A'], geography: ['Nordics', 'Northern Europe'],
    checkMin: 220000, checkMax: 2200000,
    thesis: 'Nordic early-stage firm; August 2026 ocean-tech and deep-tech vehicles for pre-seed through Series A.',
    source: 'https://www.redstone.vc/', type: 'VC', investorType: 'VC',
  },
];
