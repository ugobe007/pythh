...
const organizations = [
  ...
  // Post-#54 roster unlock organizations
  ['Pivot Ventures', 'pivotvc.com', ['Pivot Ventures']],
  ['Engineering Capital', 'engineeringcapital.com', ['Engineering Capital']],
  ['Harmony Partners', 'harmonyvp.com', ['Harmony Partners', 'Harmony']],
  ['Hirtle Callaghan', 'hirtlecallaghan.com', ['Hirtle Callaghan']],
  ['Ananda Impact Ventures', 'ananda.vc', ['Ananda Impact Ventures', 'Ananda']],
  ['Desai Ventures', null, ['Desai Ventures']],
  ['Findus Ventures', null, ['Findus Ventures']],
  ['E2MC', 'e2mc.space', ['E2MC']],
  ['Pi Labs', 'pilabs.vc', ['Pi Labs']],
  ['Golub Growth', 'golubgrowth.com', ['Golub Growth', 'Golub Capital']],
  ['Axon Partners Group', 'axonpartnersgroup.com', ['Axon Partners Group']],
  ['SmartCap', 'smartcap.pt', ['SmartCap']],
  ['Taiwania Capital', 'taiwaniacapital.com', ['Taiwania Capital']],
  ['CBMM', 'cbmm.com', ['CBMM']],
  ['InsurTech Fund', 'insurtechfund.com', ['InsurTech Fund']],
  ['Entropy Ventures', null, ['Entropy Ventures']],
  ['AlbionVC', 'albion.vc', ['AlbionVC', 'Albion VC']],
  ['PROfounders Capital', 'profounderscapital.com', ['PROfounders Capital', 'PROfounders']],
  ['Ascension', 'ascension.vc', ['Ascension']],
