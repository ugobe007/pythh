...
function extractSectorPivotSignals(text, startupName = '') {
  ...
  for (const pattern of pivotPatterns) {
    ...
    while ((match = pattern.exec(text)) !== null) {
      ...
      const isTier1 = tier1Investors.some(t1 => investorName.toLowerCase().includes(t1.toLowerCase()));
...
function extractSocialProofCascadeSignals(text) {
  ...
  for (const pattern of leadPatterns) {
    ...
    while ((match = pattern.exec(text)) !== null) {
      ...
      const isTier1 = tier1Investors.some(t1 => leaderName.toLowerCase().includes(t1.toLowerCase()));
