...
const NON_STARTUP_PATTERNS = [
  ...
  /^show hn:/i,
  /^tell hn:/i,
  /\b(trump|biden|election|congress|senate|hegseth|politician|governor)\b/i,
  /\b(streep|seinfeld|kardashian|swift|celebrity|actor|actress|singer|comedian)\b/i,
  /\b(nfl|nba|mlb|fifa|soccer|football|basketball|ufc|gym)\b/i,
  /\?$/,  // Questions
