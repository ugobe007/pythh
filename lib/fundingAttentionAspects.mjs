...
const ASPECT_PATTERNS = Object.freeze({
  ...
  product_rev: [
    /\b(launches?|launched|unveils?|unveiled|releases?|released|ships?|shipped)\b.{0,48}\b(product|platform|feature|version|app)\b/i,
    /\b(product|platform|feature|version|app)\b.{0,32}\b(launches?|launched|unveils?|unveiled|releases?|released)\b/i,
    /\bgeneral availability\b|\b\bga launch\b/i,
