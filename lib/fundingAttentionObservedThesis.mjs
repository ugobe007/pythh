...
export function mergeObservedThesis(existingSignals, observation) {
  ...
  byEvent[eventId] = {
    ...
    why_funding: observation.why_funding || observation.whyFunding || null,
    triggers: Array.isArray(observation.triggers) ? observation.triggers : [],
    as_of: asOf,
  ...
  signals.observed_thesis = {
    ...
    patterns: observed.patterns || null,
  };
  return signals;
}
