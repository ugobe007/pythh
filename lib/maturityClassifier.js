...
const SIGNAL_MATURITY_WEIGHTS = {
  ...
  gtm_hiring_signal:         3,   // GTM / sales hiring
  engineering_hiring_signal: 3, // eng hiring
  ...
  diligence_signal:          7,   // data room / formal DD
  ...
  switch (currentLevel) {
    ...
    case 'sophomore':
      if (!recentSignals.has('hiring_signal')
          && !recentSignals.has('gtm_hiring_signal')
          && !recentSignals.has('engineering_hiring_signal'))
