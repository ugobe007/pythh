...
const SIGNALS = [
  ...
  {
    category: 'FOUNDER_EXCELLENCE', signal: 'EXCELLENCE_BAR',
    signal_type: 'LANGUAGE', strength: 0.80, stage: 'any', actor: 'FOUNDER',
    meaning: 'Founder sets high excellence bar — quality culture',
    anchors: [
      'raise the bar',
      'world class',
      'best in class',
  ...
  {
    category: 'FOUNDER_CUNNING', signal: 'SHIP_FAST',
    signal_type: 'LANGUAGE', strength: 0.78, stage: 'any', actor: 'FOUNDER',
    meaning: 'Bias for action — ship fast, iterate',
    anchors: [
      'ship fast',
      'move fast',
      'bias for action',
  ...
  {
    category: 'CUSTOMER_DELIGHT', signal: 'CUSTOMER_OBSESSION',
    signal_type: 'LANGUAGE', strength: 0.82, stage: 'any', actor: 'FOUNDER',
    meaning: 'Customer delight obsession',
    anchors: [
  ...
  {
    category: 'FAILURE_LEARNING', signal: 'COMEBACK',
    signal_type: 'LANGUAGE', strength: 0.82, stage: 'any', actor: 'FOUNDER',
    meaning: 'Failure converted to learning with forward motion',
    anchors: [
