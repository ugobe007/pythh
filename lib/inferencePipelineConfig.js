...
const DEFAULTS = {
  ...
  /** needs_url HTML-only pass before junk reclassify (when --run-entity-gate) */
  STARTUP_TIGHTEN_URL_RESOLVE_DEFAULT: 200,
...
function getResolved() {
  return {
    ...
    STARTUP_TIGHTEN_URL_RESOLVE_DEFAULT: intEnv('STARTUP_TIGHTEN_URL_RESOLVE_DEFAULT', DEFAULTS.STARTUP_TIGHTEN_URL_RESOLVE_DEFAULT),
