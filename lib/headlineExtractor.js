...
function extractCompanyName(text) {
  ...
  // Disassociation: reject descriptor fragments (e.g. "AI Cow Collar Startup", "AI Cow Collar")
  ...
  candidate = candidate
    ...
    .replace(/\s*\(.*?\)\s*$/, '')
    .replace(/^(?:norwegian|swedish|finnish|danish|french|german|british|american|indian|chinese)\s+/i, '')
    .trim();
