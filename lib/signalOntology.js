...
const NEGATION_PATTERNS = [
  // Explicit not + action
  /\b(not|never|no longer|aren.?t|don.?t|won.?t|can.?t|isn.?t|didn.?t)\s+(currently\s+)?(hiring|raising|fundraising|expanding|launching|acquiring|growing|scaling|recruiting|building)\b/i,
