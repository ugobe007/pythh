...
export const CORE_FUNDING_INFERENCE_SITE_QUERY =
  '(site:news.crunchbase.com OR site:techcrunch.com OR site:dealroom.co OR site:producthunt.com OR site:angellist.com OR site:wellfound.com OR site:geekwire.com) (raises OR funding OR series OR launch)';
